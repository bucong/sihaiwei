...
export function thirdLogin(){
  if(is_weixn_qq() === 'wx'){
    ...
    //微信测试通道
    window.location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxeb904482e11189cf&redirect_uri=http%3a%2f%2fshare.zrpic.com%2fjnwtv-live-cartoon-h5%2ftest.html&response_type=code&scope=snsapi_userinfo&state="+thridLoginUrl.qqEncode+"%2f#wechat_redirect";
  }else{
    // 其他浏览器使用QQ
